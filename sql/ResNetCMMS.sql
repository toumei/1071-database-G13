...
CREATE TABLE `processing` (
  ...
  KEY `FK_repairID_rma` (`malfunctionID`),
  ...
  CONSTRAINT `FK_repairID_rma` FOREIGN KEY (`malfunctionID`) REFERENCES `repair` (`repairid`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2018-12-04 23:52:34
