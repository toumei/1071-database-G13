...
CREATE TABLE `bed` (
  ...
  `bedNum` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '寢室床號',
  PRIMARY KEY (`ID`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='寢室';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='住宿生';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `boarder` VALUES (1,1,'1');
...
CREATE TABLE `time` (
  `ID` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `malfunctionID` int(10) unsigned DEFAULT NULL COMMENT '單號',
  `time` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '方便維修時段',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='時段';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-01-04 23:14:00
